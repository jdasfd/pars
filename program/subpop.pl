...
my @wine = (
    "beer014",    "beer020",    "beer024", "beer030",
    "beer033",    "beer088",    "sake002", "spirits002",
    "spirits004", "spirits011", "wine001", "wine003",
    "wine004",    "wine005",    "wine006", "wine007",
    "wine009",    "wine010",    "wine011", "wine013",
    "wine014",    "wine015",    "wine017", "wine018"
);
my @beer1 = (
...
my @beer2 = (
    "beer003", "beer004", "beer011", "beer013", "beer021", "beer027",
    "beer032", "beer034", "beer040", "beer059", "beer062", "beer063",
    "beer080", "beer083", "beer084", "beer085", "beer086", "beer091",
    "beer092"
);
my @mixed = (
    "beer005",    "beer006",    "beer023",  "beer025",
    "beer028",    "beer029",    "beer038",  "beer061",
    "bread001",   "bread002",   "bread003", "bread004",
    "spirits001", "spirits003", "wild005",  "wild006",
    "wild007"
);
...
print join(
    ",",
    (
        "location", "gene",  "asian", "wine",
        "beer1",    "beer2", "mixed", "domesticated",
        "wild",     "minus", "p-value"
    )
  ),
  "\n";
...
for my $line ( Path::Tiny::path($file_snp)->lines( { chomp => 1, } ) ) {
    ...
    print
      join(
        ",",
        (
            $fields[0],  $fields[13], $asian_mean, $wine_mean,
            $beer1_mean, $beer2_mean, $mixed_mean, $fields[1],
